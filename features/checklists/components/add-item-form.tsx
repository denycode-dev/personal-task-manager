    ...
    <div className="mt-4 space-y-2">
      <div className="flex gap-2">
        <input suppressHydrationWarning value={content} onChange={(e) => setContent(e.target.value)}
          ...
          className="flex-1 border-2 border-black px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
          disabled={isPending} />
        ...
        <button suppressHydrationWarning onClick={submit} disabled={isPending || !content.trim()}
          className="px-4 py-2 bg-yellow-400 border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] disabled:opacity-50">
